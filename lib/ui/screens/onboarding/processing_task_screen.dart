...
class processing_task_screen extends StatefulWidget {
  const processing_task_screen({super.key});

  @override
  State<processing_task_screen> createState() => _processing_task_screenState();
}

class _processing_task_screenState extends State<processing_task_screen> {
  @override
                ...
                return ListTile(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => new_task_screen(),),);
                  },
                  title: Text(e),
                );
              }).toList()),
